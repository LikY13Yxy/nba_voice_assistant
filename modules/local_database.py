...
def _seed_faq(c):
    faqs = [
        ...
        ("什么是工资帽", "NBA工资帽是联盟规定的球队薪资上限，2024-25赛季工资帽约为1.406亿美元。奢侈税线约为1.708亿美元。", "规则"),
...
def _seed_season_stats(c):
    season_stats = [
        (1, "2024-25", "LAL", 70, 24.4, 7.8, 8.2, 1.0, 0.6, 49.7, 35.2, 74.8, 35.2),
        (2, "2024-25", "GSW", 64, 22.5, 5.1, 6.3, 1.1, 0.3, 45.0, 40.8, 92.3, 32.1),
        (3, "2024-25", "PHX", 62, 26.8, 6.2, 4.0, 0.8, 1.2, 52.1, 38.5, 86.8, 36.2),
        (4, "2024-25", "MIL", 65, 28.5, 11.5, 5.8, 0.9, 1.2, 55.8, 25.6, 62.5, 33.5),
        (5, "2024-25", "DEN", 70, 25.2, 12.8, 8.6, 1.2, 0.6, 57.2, 34.5, 82.8, 34.8),
        (6, "2024-25", "LAL", 52, 28.2, 8.2, 7.8, 1.8, 0.5, 46.8, 34.2, 76.5, 35.5),
        (7, "2024-25", "LAL", 68, 24.8, 11.5, 3.2, 1.2, 2.2, 52.5, 28.8, 78.5, 35.2),
        (18, "2024-25", "OKC", 76, 32.7, 5.0, 6.4, 1.7, 1.0, 51.8, 37.2, 89.8, 34.2),
        (17, "2024-25", "MIN", 72, 27.5, 5.8, 4.2, 1.2, 0.5, 46.2, 38.5, 82.5, 35.8),
        (11, "2024-25", "BOS", 72, 26.8, 8.2, 4.8, 1.0, 0.5, 45.8, 36.2, 84.5, 36.2),
        (12, "2024-25", "BOS", 68, 22.5, 6.2, 4.5, 1.2, 0.5, 47.2, 35.8, 72.5, 34.5),
        (29, "2024-25", "SAS", 52, 24.2, 10.8, 3.8, 1.2, 3.8, 47.5, 32.8, 82.5, 32.5),
    ]
